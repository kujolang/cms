...
1. `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo`
2. `CMS_TEST_PORT=53100 KUJO_BIN=kujo bash scripts/integration-stage1.sh`
3. `CMS_SMOKE_PORT=53110 KUJO_BIN=kujo bash scripts/smoke-api.sh`
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`7 passed`, `0 failed`).
- `CMS_TEST_PORT=59320 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59330 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`7 passed`, `0 failed`).
- `CMS_TEST_PORT=59340 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59350 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`7 passed`, `0 failed`).
- `CMS_TEST_PORT=59360 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59370 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`7 passed`, `0 failed`).
- `CMS_TEST_PORT=59380 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59390 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`7 passed`, `0 failed`).
- `CMS_TEST_PORT=59400 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59410 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`8 passed`, `0 failed`).
- `CMS_TEST_PORT=59420 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59430 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`8 passed`, `0 failed`).
- `CMS_TEST_PORT=59440 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59450 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`8 passed`, `0 failed`).
- `CMS_TEST_PORT=59460 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59470 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`8 passed`, `0 failed`).
- `CMS_TEST_PORT=59480 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59490 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`8 passed`, `0 failed`).
- `CMS_TEST_PORT=59520 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59530 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`9 passed`, `0 failed`).
...
- `KUJO_BIN=kujo test-run tests/cms_contract_tests.kujo` -> pass (`9 passed`, `0 failed`).
- `KUJO_BIN=kujo CMS_SMOKE_PORT=50060 bash scripts/smoke-api.sh` -> pass (smoke checks passed).
- `KUJO_BIN=kujo CMS_TEST_PORT=50071 bash scripts/integration-stage1.sh` -> pass (Stage 1 integration assertions passed).
- `KUJO_BIN=kujo CMS_SECURITY_TEST_PORT_BASE=49940 bash scripts/integration-enterprise-security.sh` -> pass (enterprise security integration passed).
- `KUJO_BIN=kujo CMS_GRACEFUL_PORT=49950 bash scripts/validate-graceful-restart.sh` -> pass.
- `KUJO_BIN=kujo CMS_OPS_LOAD_PERF_RUNS=6 CMS_OPS_LOAD_PERF_PORT=49990 CMS_OPS_LOAD_MIGRATION_PORT=49991 CMS_OPS_LOAD_PORT=49992 bash scripts/ops-load-validation.sh` -> pass.
...
- `KUJO_BIN=kujo CMS_GATE_PERF_RUNS=3 CMS_GATE_PORT_BASE=50020 bash scripts/run-release-gate.sh` -> partial (through Stage 2 Round 2; failing at sitemap index structure, tracked for follow-up).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass.
- `CMS_TEST_PORT=59820 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass.
- `CMS_SMOKE_PORT=59830 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass.
...
- `CMS_TEST_PORT=59700 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all Stage 1 integration checks passed).
...
- `CMS_SMOKE_PORT=59710 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
- `CMS_TEST_PORT=59540 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59550 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`9 passed`, `0 failed`).
- `CMS_TEST_PORT=59560 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59570 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `CMS_COMPAT_PORT=59580 KUJO_BIN=kujo bash scripts/verify-compat-startup.sh` -> pass (`Compatibility startup checks passed.`).
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`9 passed`, `0 failed`).
- `CMS_TEST_PORT=59590 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59610 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `CMS_COMPAT_PORT=59620 KUJO_BIN=kujo bash scripts/verify-compat-startup.sh` -> pass (`Compatibility startup checks passed.`).
- `CMS_TEST_PORT=59630 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59640 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`9 passed`, `0 failed`).
- `CMS_TEST_PORT=59650 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59660 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> pass (smoke checks passed).
...
- `CMS_COMPAT_PORT=59670 KUJO_BIN=kujo bash scripts/verify-compat-startup.sh` -> pass (`Compatibility startup checks passed.`).
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`9 passed`, `0 failed`).
...
- `KUJO_BIN=kujo kujo test-run tests/cms_contract_tests.kujo` -> pass (`9 passed`, `0 failed`).
- `CMS_TEST_PORT=59680 KUJO_BIN=kujo bash scripts/integration-stage1.sh` -> pass (all assertions passed).
- `CMS_SMOKE_PORT=59690 KUJO_BIN=kujo bash scripts/smoke-api.sh` -> initial failure (`Address already in use`), re-run on `CMS_SMOKE_PORT=59691` -> pass (smoke checks passed).
